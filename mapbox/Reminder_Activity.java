...
public class Reminder_Activity extends AppCompatActivity{
    ...
    private android.support.design.widget.FloatingActionButton mAddReminderButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("LayoutManager Passed");
    ...
    private void initBackFab(){
        FloatingActionButton backFab = findViewById(R.id.back_to_map);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        private ArrayList<ReminderElement> mItems;
        ...
        public void onBindViewHolder(VerticalItemHolder itemHolder, int position) {
            ReminderElement item = mItems.get(position);
        ...
        public  class ReminderElement {
            ...
            public ReminderElement(String Title, String DateTime, String Repeat, String RepeatNo, String RepeatType, String Active) {
                this.mTitle = Title;
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public boolean onLongClick(View v) {
                AppCompatActivity activity = Reminder_Activity.this;
            ...
            public void setActiveImage(String active){
                if(active.equals("true")){
                    mActiveImage.setImageResource(R.drawable.ic_clear);
                }else if (active.equals("false")) {
                    mActiveImage.setImageResource(R.drawable.ic_circle);
                }
            }
        }

        // Generate random test data
        public  ReminderElement generateDummyData() {
            return new ReminderElement("1", "2", "3", "4", "5", "6");
        }

        // Generate real data for each item
        public List<ReminderElement> generateData(int count) {
            ArrayList<ReminderElement> items = new ArrayList<>();
            ...
            for (DateTimeSorter item:DateTimeSortList) {
                ...
                items.add(new SimpleAdapter.ReminderElement(Titles.get(i), DateAndTime.get(i), Repeats.get(i),
