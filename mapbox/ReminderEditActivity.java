...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    private TextView mDateText, mTimeText, mRepeatText, mRepeatNoText, mRepeatTypeText, mAddressText;
...
//        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        mAddressText = (TextView) findViewById(R.id.set_address);
...
//        getSupportActionBar().setHomeButtonEnabled(true);
        ...
        mAdress = mReceivedReminder.getAddress();
        ...
        if (savedInstanceState != null) {
            ...
            String savedAddressType = savedInstanceState.getString(KEY_ADDRESS);
            mAddressText.setText(savedAddressType);
            mAdress = savedAddressType;
        }
    ...
    protected void onSaveInstanceState (Bundle outState) {
        ...
        outState.putCharSequence(KEY_ADDRESS, mAddressText.getText());
    }
    ...
    public void updateReminder(){
        ...
        mReceivedReminder.setAddress(mAdress);
        // Update reminder
